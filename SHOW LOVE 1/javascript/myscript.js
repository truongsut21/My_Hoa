...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim thầy đang đập nhanh " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'Em quá là yêu thích thầy em đó <i class="fas fa-heart"></i> ';
